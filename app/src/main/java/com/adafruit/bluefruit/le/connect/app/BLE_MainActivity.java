...
public class BLE_MainActivity extends AppCompatActivity implements BleManager.BleManagerListener, BleUtils.ResetBluetoothAdapterListener, FirmwareUpdater.FirmwareUpdaterListener {
    // Constants
    private final static String TAG = BLE_MainActivity.class.getSimpleName();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_help) {
            ...
            intent.setClass(BLE_MainActivity.this, SettingsActivity.class);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BleUtils.enableWifi(true, BLE_MainActivity.this);
                            BLE_MainActivity.super.onBackPressed();
                        }
...
//                                mComponentToStartWhenConnected = UartActivity.class;
    ...
    public void onClickDeviceConnect(View view) {
        ...
        if (scannedDeviceIndex < mScannedDevices.size()) {
            ...
            mBleManager.setBleListener(BLE_MainActivity.this);           // Force set listener (could be still checking for updates...)
...
//            Log.d(TAG, "record -> lenght: " + length + " type:" + type + " data" + data);
    ...
    private void launchComponentActivity() {
        ...
        showConnectionStatus(false);
        if (mComponentToStartWhenConnected != null) {
            Intent intent = new Intent(BLE_MainActivity.this, mComponentToStartWhenConnected);
        ...
        if (isFailedInstallationDetected) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    new AlertDialog.Builder(BLE_MainActivity.this)
                            ...
                            .setPositiveButton(R.string.scan_failedupdatedetected_ok, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    mFirmwareUpdater.startFailedInstallationRecovery(BLE_MainActivity.this);
                                }
                            })
                            .setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    FirmwareUpdater.clearFailedInstallationRecoveryParams(BLE_MainActivity.this);
                    ...
                    new AlertDialog.Builder(BLE_MainActivity.this)
                            ...
                            .setPositiveButton(R.string.scan_softwareupdate_install, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    mFirmwareUpdater.downloadAndInstall(BLE_MainActivity.this, latestRelease);
                                }
                            })
