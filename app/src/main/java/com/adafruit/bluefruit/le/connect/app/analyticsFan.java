...
public class analyticsFan extends UartInterfaceActivity implements BleManager.BleManagerListener {

    // BLE
    private final static String TESTBLAH = analyticsFan.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analytics_fan);
        ...
        scheduling.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent startScheduling = new Intent(analyticsFan.this, com.adafruit.bluefruit.le.connect.app.AlarmActivity.class);
...
//         ********************** PI CHART ******************************
        ...
        piechartstart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent startPIChart = new Intent(analyticsFan.this, com.adafruit.bluefruit.le.connect.app.PieChartActivity.class);
...
//         ***************************************************************
        ...
        linegraphstart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent startLineGraph = new Intent(analyticsFan.this, com.adafruit.bluefruit.le.connect.app.LineChartActivity1.class);
        ...
        // ********************** Refresh Button ******************************
        FloatingActionButton refreshAction = (FloatingActionButton) findViewById(R.id.refreshAction);
